...
function runTestCombineFilters() {
  describe('Combine Filters', () => {
    ...
    it('should return false if any filter does', () => {
      expect(combineFilters(checkStateNot1, checkStateNot2)(null, 1)).to.equal(
        false,
      )
      expect(combineFilters(checkStateNot1, checkStateNot2)(null, 2)).to.equal(
        false,
      )
    })

    it('should return true if every filter does', () => {
      expect(combineFilters(checkStateNot1, checkStateNot2)(null, 3)).to.equal(
        true,
      )
    })
